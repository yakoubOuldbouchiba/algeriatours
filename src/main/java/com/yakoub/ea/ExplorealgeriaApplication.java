...
import com.yakoub.ea.services.TourPackageService;
...
public class ExplorealgeriaApplication implements CommandLineRunner {
	...
	public static void main(String[] args) {
		SpringApplication.run(ExplorealgeriaApplication.class, args);
	}
